--[ResSpecial])).[RestaurantMerchantNumbers]))
--[FileUpload])).[ResSpecialAdditions]))


use Sandbox;

truncate table ResSpecial.RestStaging 


insert into ResSpecial.RestStaging 
...
FROM [Sandbox].[dbo].[ResSpecial_Additions_20230920_csv]
--FROM [Sandbox].[dbo].[ResSpecial Additions 20230919]
  

 --select * from  ResSpecial.RestStaging      
   select * from  ResSpecial.RestStaging  
