...
-- kreiranje kopija tabela
  ...
  --Seated.RestaurantsStaging_2 
  --Seated.RestaurantsStaging_mycopy

use Sandbox;

-- DROP TABLE IF EXISTS Seated.RestaurantsStaging_2 

-- CREATE TABLE Seated.RestaurantsStaging_2 (

TRUNCATE TABLE Seated.RestaurantsStaging_2 
...
--	 SELECT * FROM Seated.RestaurantsStaging_2 

-- INSERT block 

insert into Seated.RestaurantsStaging_2
...
--	 FROM [Sandbox].[Seated].[RestaurantsStaging]
	 FROM [Seated].RestaurantStaging_November2024

  --FROM [Sandbox].[dbo].[Seated Additions 20241021]


  select * from [Sandbox].[Seated].[RestaurantsStaging_2] 
  select * from [Sandbox].[Seated].[RestaurantsStaging]    



  --SELECT distinct restaurant_id FROM [Seated].[RestaurantsStaging_2]  
  SELECT distinct restaurant_id FROM [Seated].[RestaurantsStaging] 
  SELECT count(1) FROM [Seated].[RestaurantsStaging]	
